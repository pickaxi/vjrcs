...
from TechVJ.dump import get_dump_channel
...
async def save(client: Client, message: Message):
    if "https://t.me/" in message.text:
        ...
        # Universal batch progress message for range > 1
        progress_msg = None
        if total > 1:
            ...
            try:
                ...
                pass  # In case bot has no pin permission
        ...
        for idx, msgid in enumerate(range(fromID, toID+1), start=1):
            ...
            # Update batch universal progress message
